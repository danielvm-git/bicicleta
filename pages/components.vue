...
const { data: components, refresh: refreshComponents, pending } = await useFetch('/api/components', {
...
<template>
  <div class="py-8">
    <div class="flex items-center justify-between mb-8">
      ...
      <UButton to="/" variant="ghost" icon="i-heroicons-arrow-left">Voltar</UButton>
    </div>
    ...
    <UCard class="mb-8">
      ...
      <div class="flex justify-end mt-4" v-if="category || brand || line || search">
        <UButton color="gray" variant="ghost" @click="clearFilters">Limpar Filtros</UButton>
      </div>
    </UCard>
